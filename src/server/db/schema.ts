...
export const podcastCharactersRelations = relations(podcastCharacters, ({ one }) => ({
  podcast: one(podcasts, { fields: [podcastCharacters.podcastId], references: [podcasts.id] }),
  character: one(characters, { fields: [podcastCharacters.characterId], references: [characters.id] }),
}))

export const podcastSegmentsRelations = relations(podcastSegments, ({ one }) => ({
  podcast: one(podcasts, { fields: [podcastSegments.podcastId], references: [podcasts.id] }),
  character: one(characters, { fields: [podcastSegments.characterId], references: [characters.id] }),
}))
